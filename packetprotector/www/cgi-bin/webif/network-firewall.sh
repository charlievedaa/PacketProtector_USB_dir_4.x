...
ports|FORM_sport|@TR<<Source Port>>||$FORM_sport
ports|FORM_dport|@TR<<Destination Port>>||$FORM_dport
...
function iptstr2web(str, ret) {
	...
	if (_l["sport"] != "") ret = ret "@TR<<Source Port>>: " _l["sport"] "<br />"
	if (_l["dest"] != "") ret = ret "@TR<<Destination IP>>: " _l["dest"] "<br />"
	if (_l["dport"] != "") ret = ret "@TR<<Destination Port>>: " _l["dport"] "<br />"
...
function iptstr2edit(str, edit) {
	...
	if (_l["sport"] != "") edit = edit input_line("Source Port", "sport", _l["sport"])
	if (_l["dest"] != "") edit = edit input_line("Destination IP", "dest", _l["dest"])
	if (_l["dport"] != "") edit = edit input_line("Destination Port", "dport", _l["dport"])
	...
	if ((_l["proto"] == "tcp") || (_l["proto"] == "udp") || (_l["proto"] == "")) {
		if (_l["sport"] == "") edit = edit sel_option("sport", "Source Port")
		if (_l["dport"] == "") edit = edit sel_option("dport", "Destination Port")
